...
class Process(models.Model):
    ...
    def _parse_json(self):
        ...
        _logger.warning(_json_record)
        if _json_record or _json_record.datas:
            _logger.warning("111")
            import base64
            self.export_data = base64.b64decode(_json_record.datas).decode('utf-8')
        else:
            raise UserError('Not found the json file!')
